...
\begin{itemize}
    \item \textbf{11 Checkpoint Questions} embedded throughout Chapter 4, testing conceptual understanding of ERIs and the Boys function
...
This section provides detailed answers to all 11 checkpoint questions from Chapter 4,
...
\textbf{Special cases:}
\begin{itemize}
    \item $\eri{\mu}{\mu}{\lambda}{\lambda}$: Coulomb repulsion between diagonal charge densities (``classical'' repulsion)
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 4.7: Understanding ``Exactness'' in Quadrature}
\label{sec:cp47}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 4.8: Root Count Practice}
\label{sec:cp48}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 4.9: Numerical Stability of Boys Evaluation}
\label{sec:cp49}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 4.10: Understanding the $(ss|ss)$ ERI}
\label{sec:cp410}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 4.11: Quadrature Difficulty vs.\ Parameter $T$}
\label{sec:cp411}
%-------------------------------------------------------------------------------
