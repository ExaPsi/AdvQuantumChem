...
\begin{itemize}
    \item \textbf{12 Checkpoint Questions} embedded throughout Chapter 5, testing conceptual understanding
...
This section provides detailed answers to all 12 checkpoint questions from Chapter 5,
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.7: Method Equivalence (Section 5.6)}
\label{sec:cp57}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.8: Identifying Derivative Sources (Section 5.7)}
\label{sec:cp58}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.9: Structure of the $(ps|ss)$ Formula (Section 5.7)}
\label{sec:cp59}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.10: Crossed Indices in Exchange (Section 5.8)}
\label{sec:cp510}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.11: Symmetry of J and K (Section 5.8)}
\label{sec:cp511}
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
\subsection{Checkpoint 5.12: Why $\mat{V}_{HF}$ Rather Than Separate $\Jmat$ and $\Kmat$ (Section 5.9)}
\label{sec:cp512}
%-------------------------------------------------------------------------------
...
$T$ & $x_1$ & $x_2$ & $W_1$ & $W_2$ \\
\midrule
0.0 & 0.1127 & 0.5000 & 0.7182 & 1.2818 \\
0.1 & 0.1089 & 0.4950 & 0.6917 & 1.2155 \\
1.0 & 0.0960 & 0.6969 & 0.4063 & 1.0873 \\
10.0 & 0.0290 & 0.3339 & 0.0911 & 0.2247 \\
\bottomrule
\end{tabular}
\end{center}
...
Energy reconstruction check:
  E_elec (from integrals) = -82.94454706
  E_elec (from PySCF)     = -82.94454706
  Difference              = 2.84e-13 Hartree

  E_nuc = 8.00236707
  E_tot = -74.94218000 Hartree
  PySCF E_tot = -74.94218000 Hartree
\end{verbatim}
\end{outputbox}
...
Brief answers for the end-of-chapter exercises (Section 5.11).
...
\begin{itemize}
    ...
    \item PySCF reference: $E_{\text{tot}} \approx -74.9659$ Hartree
\end{itemize}
